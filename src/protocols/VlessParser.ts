...
export interface VlessHeader {
    hasError: boolean, addressType?: ADDRESS_TYPE, port?: number, hostname?:string, isUDP?: boolean, rawIndex?: number, version?:Uint8Array, message?: string
}

export class VlessParser {
    static parseHeader(chunk: ArrayBuffer, token: string) : VlessHeader{
